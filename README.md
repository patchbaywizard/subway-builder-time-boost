<img src="time-boost/images/icon.png" alt="Time Boost clock and subway icon" width="128" />
...
![Time Boost controls showing Boost 1 through Boost 5, Reset, and an actual speed of 2.81 game hours per real second](time-boost/images/time-boost.png)
...
[Attribution and credits](time-boost/ATTRIBUTION.md)
